    ...
    <div className="space-y-8 px-4 py-16">
      {[1, 1, 1, 1, 1, 1].map((_, i) => (
        <div className="flex flex-col items-start" key={i}>
          <span className="flex cursor-pointer items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">
            동네질문
          </span>
      ...
      <button className="fixed bottom-5 right-5 cursor-pointer rounded-full bg-orange-400 p-4 text-white shadow-xl transition-colors hover:bg-orange-500">
        <svg
          className="h-6 w-6"
          fill="none"
          stroke="currentColor"
